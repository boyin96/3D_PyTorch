...
class PointNetfeat(nn.Module):
    ...
    def __init__(self, num_points=2500, k=64, global_feat=True, input_trans=False, feature_trans=False):
...
class PointNetCls(nn.Module):
    def __init__(self, num_points=2500, classes=2, input_trans=False, feature_trans=False):
        ...
        self.feat = PointNetfeat(self.num_points, global_feat=True, input_trans=self.input_trans,
